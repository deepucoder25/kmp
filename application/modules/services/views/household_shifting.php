    ...
    <section class="py-5 service-z-index-up">
        <div class="container">
            <div class="row">
                    ...
                    <div class="service-glass-panel">
                        ...
                        <div class="mb-4">
                            <div class="w-100 position-relative overflow-hidden rounded-4 shadow-sm service-featured-img-container">
                                <img src="<?= base_url('assets/images/services_modules/whatsapp_image_1.jpg') ?>" alt="Household Shifting" class="img-fluid w-100 h-100 object-fit-cover" loading="lazy">
                            </div>
                        </div>
                        ...
                        <div class="service-metric-row">
                            <div class="service-metric-card-3d">
                                <div class="service-metric-num-3d">100%</div>
                                <div class="service-metric-label-3d">Safe Packing</div>
                                <div class="service-metric-desc-3d">Premium multi-layer materials.</div>
                            </div>
                            <div class="service-metric-card-3d">
                                <div class="service-metric-num-3d">On-Time</div>
                                <div class="service-metric-label-3d">Delivery Guarantee</div>
                                <div class="service-metric-desc-3d">Committed shifting schedules.</div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <?php $this->load->view('services_sidebar', ['active_link' => 'household-shifting']); ?>
                </div>
            </div>
        </div>
    </section>
